...
void CompilerUtils::accessCalldataTail(Type const& _type)
{
	...
	("revertString", m_context.revertReasonIfDebug("Invalid calldata offset"))
		...
		if (type->category() == Type::Category::Array)
		{
			...
			if (_fromMemory)
			{
				...
				if (arrayType.isDynamicallySized())
				{
					...
					templ("revertStringPointer", m_context.revertReasonIfDebug("ABI decoding error: invalid data pointer"));
					templ("revertStringStart", m_context.revertReasonIfDebug("ABI decoding error: invalid data start"));
					templ("revertStringLength", m_context.revertReasonIfDebug("ABI decoding error: invalid data length"));
			...
			else
			{
				...
				if (calldataType->isDynamicallySized())
				{
					...
					("revertString", m_context.revertReasonIfDebug("Invalid data offset"))
					.render(), {"data_offset"});
					...
					("revertString", m_context.revertReasonIfDebug("Invalid head pointer"))
					...
					("revertString", m_context.revertReasonIfDebug("Invalid data pointer"))
